...
ShareService.ɵfac = function ShareService_Factory(t) { return new (t || ShareService)(ɵngcc0.ɵɵinject(SHARE_BUTTONS_CONFIG, 8)); };
ShareService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: ShareService, factory: ShareService.ɵfac, providedIn: 'root' });
/** @nocollapse */
...
ShareDirective.ɵfac = function ShareDirective_Factory(t) { return new (t || ShareDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Meta), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.HttpClient), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ShareService), ɵngcc0.ɵɵdirectiveInject(DOCUMENT)); };
ShareDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: ShareDirective, selectors: [["", "shareButton", ""], ["", "share-button", ""]], hostVars: 2, hostBindings: function ShareDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("click", function ShareDirective_click_HostBindingHandler() { return ctx.share(); });
    } if (rf & 2) {
        ɵngcc0.ɵɵstyleProp("pointer-events", ctx.pointerEvents);
    } }, inputs: { getCount: "getCount", autoSetMeta: "autoSetMeta", url: "url", title: "title", description: "description", image: "image", tags: "tags", shareButtonName: ["shareButton", "shareButtonName"] }, outputs: { count: "count", opened: "opened", closed: "closed" }, features: [ɵngcc0.ɵɵNgOnChangesFeature] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ShareDirective, [{
    ...
    }], function () { return [{ type: ɵngcc1.Meta }, { type: ɵngcc0.ElementRef }, { type: ɵngcc2.HttpClient }, { type: ɵngcc3.Platform }, { type: ɵngcc0.Renderer2 }, { type: ɵngcc0.ChangeDetectorRef }, { type: ShareService }, { type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
            }] }]; }, { getCount: [{
            type: Input
...
ShareCountPipe.ɵpipe = /*@__PURE__*/ ɵngcc0.ɵɵdefinePipe({ name: "shareCount", type: ShareCountPipe, pure: true });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ShareCountPipe, [{
        type: Pipe,
        args: [{
                name: 'shareCount'
            }]
...
ShareModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [PlatformModule] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ShareModule, { declarations: function () { return [ShareDirective, ShareCountPipe]; }, imports: function () { return [PlatformModule]; }, exports: function () { return [ShareDirective, ShareCountPipe]; } }); })();
